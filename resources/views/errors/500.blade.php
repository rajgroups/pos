...
<body class="error-page">
    ...
    <div class="main-wrapper">
        <div class="error-box">
            <div class="error-img">
                <img src="{{ asset('theme/html/template/assets/img/authentication/error-500.png') }}" class="img-fluid" alt="Img">
            </div>
            <h3 class="h2 mb-3">Database Connection Failed</h3>
            <p>We are currently experiencing database connectivity issues.<br>
