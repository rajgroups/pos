	...
	{{-- <script src="{{ asset('resource/admin/assets/js/theme-script.js') }} " type="314ef8566fc3c8eb9fca1a7e-text/javascript"></script> --}}
	...
	<!-- Tabler Icon CSS -->
	<link rel="stylesheet" href="{{ asset('resource/admin/assets/plugins/tabler-icons/tabler-icons.css')}}">
