                                    ...
                                    <div class="card">
                                        <div class="card-body p-5">
                                            <div class="login-userheading">
                                                <h3>Sign In</h3>
                                                <h4>Access the Pos panel using your Mobile and passcode.</h4>
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <div class="d-flex align-items-center justify-content-center flex-wrap">
                                                    ...
                                                    <div class="text-center me-2 flex-fill">
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            <img class="img-fluid m-1" src="{{ asset('theme/html/template/assets/img/icons/google-logo.svg') }}" alt="Facebook">
                                                        </a>
                                                    </div>
