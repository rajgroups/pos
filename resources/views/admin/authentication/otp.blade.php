            ...
            <div class="row w-100">
                <div class="col-lg-5 mx-auto">
                    <div class="login-content user-login">
                        ...
                        <form action="https://dreamspos.dreamstechnologies.com/html/template/reset-password.html"
                            class="digit-group">
                            <div class="card">
                                <div class="card-body p-5">
                                    <div class="login-userheading">
                                        <h3>2 Step Verification</h3>
                                        <h4>Enter the OTP sent to +91**********<a
                                                href="https://dreamspos.dreamstechnologies.com/cdn-cgi/l/email-protection"
                                                class="__cf_email__"
                                                data-cfemail="e6828983a6839e878b968a83c885898b">[email&#160;protected]</a>
                                            to confirm your account.</h4>
                                    </div>
                                    <div class="text-center otp-input">
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                maxlength="1">
                                            <input type="text"
                                                class=" rounded w-100 py-sm-3 py-2 text-center fs-26 fw-bold" id="digit-4"
                                                name="digit-4" data-next="digit-5" data-previous="digit-3" maxlength="1">
                                        </div>
                                        <div>
                                            <div class="badge bg-danger-transparent mb-3">
                                                <p class="d-flex align-items-center "><i class="ti ti-clock me-1"></i>09:59
                                                </p>
                                            </div>
