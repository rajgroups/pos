...
@section('content')
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                <h4 class="fw-bold">Upload Driver Document</h4>
                <h6 class="text-muted">Upload a new document for a driver</h6>
            </div>
        </div>
        <div class="page-btn">
    ...
    <div class="card shadow-sm border-0">
        <form action="{{ route('admin.driver-documents.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                @if ($errors->any())
