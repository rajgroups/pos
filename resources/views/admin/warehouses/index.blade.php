...
@push('meta')
<title>Warehouse List - Lion POS</title>
<meta charset="utf-8">
...
<div class="page-header">
    <div class="page-title">
        <h4 class="fw-bold">Warehouse List</h4>
        <h6 class="text-muted">Manage all product storage warehouses</h6>
    </div>
                            ...
                            <td class="action-table-data">
                                <div class="edit-delete-action">
                                    ...
                                    <form action="{{ route('admin.warehouses.destroy', $warehouse->id) }}"
                                          method="POST" id="del_form_{{ $warehouse->id }}" style="display:none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                    ...
                                    <a href="javascript:void(0);" class="p-2 text-danger"
                                       onclick="if(confirm('Are you sure you want to delete this warehouse?')) {
                                            document.getElementById('del_form_{{ $warehouse->id }}').submit();
                                       }">
