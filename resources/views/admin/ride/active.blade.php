    ...
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                <h4 class="fw-bold">Active list</h4>
        ...
        <div class="d-flex align-items-center">
            <ul class="table-top-head">
                ...
                <li>
                 ...
                 <li>
                    <a data-bs-toggle="tooltip" data-bs-placement="top" id="collapse-header" aria-label="Collapse"
                        data-bs-original-title="Collapse" href="{{ route('admin.ride.cancelled') }}"><i class="ti ti-plus"></i></a>
                </li>
                 <li>
                    <a data-bs-toggle="tooltip" data-bs-placement="top" id="collapse-header" aria-label="Collapse"
                        data-bs-original-title="Collapse" href="{{ route('admin.ride.cancelled') }}"><i class="ti ti-pencil"></i></a>
                </li>
            </ul>
        </div>
    </div>
