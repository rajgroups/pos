    ...
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                <h4 class="fw-bold">Edit Vehicle Type</h4>
                <h6 class="text-muted">Update details for this vehicle type</h6>
            </div>
        </div>
        <div class="page-btn">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="type_key" class="form-control" value="{{ old('type_key', $category->type_key) }}">
                        </div>

                        <div class="mb-4">
                            <label class="form-label fw-semibold">Service Mode</label>
                            <select name="service_mode" class="form-select">
                                <option value="instant" {{ old('service_mode', $category->service_mode) == 'instant' ? 'selected' : '' }}>Instant</option>
                                <option value="scheduled" {{ old('service_mode', $category->service_mode) == 'scheduled' ? 'selected' : '' }}>Scheduled</option>
                                <option value="both" {{ old('service_mode', $category->service_mode) == 'both' ? 'selected' : '' }}>Both</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="tagline" class="form-control" value="{{ old('tagline', $category->tagline) }}">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" name="starting_fare" class="form-control" value="{{ old('starting_fare', $category->starting_fare) }}">
                            </div>
                            <div class="col-md-6 mb-4">
                                <label class="form-label fw-semibold">Price Label</label>
                                <input type="text" name="price_label" class="form-control" value="{{ old('price_label', $category->price_label) }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" name="eta" class="form-control" value="{{ old('eta', $category->eta) }}">
                            </div>
                            <div class="col-md-6 mb-4">
                                <label class="form-label fw-semibold">Max Capacity</label>
                                <input type="number" name="max_capacity" class="form-control" value="{{ old('max_capacity', $category->max_capacity) }}" min="1">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-4">
                                ...
                                <input type="color" name="accent_color" class="form-control form-control-color w-100" value="{{ old('accent_color', $category->accent_color ?: '#000000') }}">
                            </div>
                            <div class="col-md-4 mb-4">
                                <label class="form-label fw-semibold">Gradient Start</label>
                                <input type="color" name="gradient_start" class="form-control form-control-color w-100" value="{{ old('gradient_start', $category->gradient_start ?: '#000000') }}">
                            </div>
                            <div class="col-md-4 mb-4">
                                <label class="form-label fw-semibold">Gradient End</label>
                                <input type="color" name="gradient_end" class="form-control form-control-color w-100" value="{{ old('gradient_end', $category->gradient_end ?: '#000000') }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                @if($category->icon)
                                    <div class="mt-2">
                                        <img src="{{ asset($category->icon) }}" alt="Category Icon" width="40" class="rounded bg-light p-1">
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="mb-3 d-flex justify-content-between align-items-center bg-light p-3 rounded">
                            ...
                            <div class="form-check form-switch">
                                ...
                                <input type="checkbox" class="form-check-input" name="is_active" value="1" {{ old('is_active', $category->is_active) == 1 ? 'checked' : '' }}>
                            </div>
                        </div>
