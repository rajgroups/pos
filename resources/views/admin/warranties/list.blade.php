...
<div class="page-wrapper">
   ...
   <div class="content">
      <div class="page-header">
         ...
         <div class="page-btn">
            <a href="{{route('admin.warranty.create')}}" class="btn btn-primary"><i class="ti ti-circle-plus me-1"></i>Add Warranty</a>
         </div>
      </div>
      <!-- /product list -->
      <div class="card">
               ...
               <table class="table datatable">
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td>
                           <p class="description-para">Covers replacement of faulty items</p>
                        </td>
                        <td>2 Year</td>
                     ...
                     <tr>
                        ...
                        <td>
                           <p class="description-para">Product repairs done at the customer’s location</p>
                        </td>
                        <td>1 Year</td>
                        <td><span class="badge table-badge bg-success fw-medium fs-10">Active</span></td>
                        <td class="action-table-data">
                     ...
                     <tr>
                        ...
                        <td>
                           <p class="description-para">Coverage for accidental damage</p>
                        </td>
                        <td>6 Months</td>
                        <td><span class="badge table-badge bg-success fw-medium fs-10">Active</span></td>
                        <td class="action-table-data">
                     ...
                     <tr>
                        ...
                        <td>
                           <p class="description-para">Covers only labor costs, not parts</p>
                        </td>
                        <td>6 Months</td>
                        <td><span class="badge table-badge bg-success fw-medium fs-10">Active</span></td>
                        <td class="action-table-data">
