                ...
                <div class="card flex-fill">
                    ...
                    <div class="card-body sell-product">
                        <div class="d-flex align-items-center justify-content-between border-bottom">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="{{asset('resource/admin/assets/img/products/product-01.jpg')}}" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between border-bottom">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="{{asset('resource/admin/assets/img/products/product-16.jpg')}}" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between border-bottom">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="{{asset('resource/admin/assets/img/products/product-03.jpg')}}" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between border-bottom">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="{{asset('resource/admin/assets/img/products/product-04.jpg')}}" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="{{asset('resource/admin/assets/img/products/product-05.jpg')}}" alt="img">
                                </a>
                                <div class="ms-2">
                ...
                <div class="card flex-fill">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="{{asset('resource/admin/assets/img/products/product-06.jpg')}}" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="{{asset('resource/admin/assets/img/products/product-07.jpg')}}" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="{{asset('resource/admin/assets/img/products/product-08.jpg')}}" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="{{asset('resource/admin/assets/img/products/product-09.jpg')}}" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-0">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="{{asset('resource/admin/assets/img/products/product-10.jpg')}}" alt="img">
                                </a>
                                <div class="ms-2">
                ...
                <div class="card flex-fill">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="{{asset('resource/admin/assets/img/products/product-11.jpg')}}" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="{{asset('resource/admin/assets/img/products/product-12.jpg')}}" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="{{asset('resource/admin/assets/img/products/product-13.jpg')}}" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="{{asset('resource/admin/assets/img/products/product-14.jpg')}}" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-0">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-lg">
                                    <img src="{{asset('resource/admin/assets/img/products/product-15.jpg')}}" alt="img">
                                </a>
                                <div class="ms-2">
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center file-name-icon">
                                                        <a href="javascript:void(0);" class="avatar avatar-md">
                                                            <img src="{{asset('resource/admin/assets/img/customer/customer16.jpg')}}" class="img-fluid" alt="img">
                                                        </a>
                                                        <div class="ms-2">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center file-name-icon">
                                                        <a href="javascript:void(0);" class="avatar avatar-md">
                                                            <img src="{{asset('resource/admin/assets/img/customer/customer17.jpg')}}" class="img-fluid" alt="img">
                                                        </a>
                                                        <div class="ms-2">
